...
import com.example.petnav.overlay.WalkRouteOverlay;


public class WalkTest extends Activity implements OnMapClickListener,
    ...
    String lat, lon, SelfLon, SelfLat;
    Button goPoi;
    // 起点终点坐标
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelfLon = bundle.getString("selflongitude");
        SelfLat = bundle.getString("selflatitude");
        lon = bundle.getString("targetlongitude");
        lat = bundle.getString("targetlatitude");
        mNaviStart = new NaviLatLng(Double.parseDouble(SelfLat), Double.parseDouble(SelfLon));
        mNaviEnd = new NaviLatLng(Double.parseDouble(lat), Double.parseDouble(lon));
        mStartPoint = new LatLonPoint(Double.parseDouble(SelfLat), Double.parseDouble(SelfLon));
        mEndPoint = new LatLonPoint(Double.parseDouble(lat), Double.parseDouble(lon));


        setContentView(R.layout.route_activity);

        goPoi = findViewById(R.id.goPOI);
        goPoi.setOnClickListener(new button1_click());
    ...
    class button1_click implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.setClass(WalkTest.this, PoiAroundSearchActivity.class);
            WalkTest.this.startActivity(intent);
