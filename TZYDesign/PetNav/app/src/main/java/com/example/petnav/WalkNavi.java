...
public class WalkNavi extends Activity implements OnMapClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelfLon = bundle.getString("targetlongitude");
        SelfLat = bundle.getString("targetlatitude");
        lon = bundle.getDouble("poilongitude");
        lat = bundle.getDouble("poilatitude");
