...
public class PoiAroundSearchActivity extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lp = new LatLonPoint(Double.parseDouble(lat), Double.parseDouble(lon));
    ...
    private void setup() {
        ...
        mPoiDetail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("poiName", HospitalName);
                intent.putExtras(bundle);
                intent.setClass(PoiAroundSearchActivity.this,RoutePlanningActivity.class);
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        if (marker.getObject() != null) {
            ...
            try {
                ...
                LatLonPoint selected = ((PoiItem) marker.getObject()).getLatLonPoint();
                HospitalLat = selected.getLatitude();
                HospitalLon = selected.getLongitude();
                HospitalName = ((PoiItem) marker.getObject()).getTitle();
                detailMarker = marker;
    ...
    private void setPoiItemDisplayContent(final PoiItem mCurrentPoi) {
        ...
        mPoiAddress.setText(String.format("%s 距您%d米", mCurrentPoi.getSnippet(), mCurrentPoi.getDistance()));
    }
